...
<template>
    <div v-if="connected">
        <div class="px-8 py-4 border-l-4 border-blue-500">
            <div class="py-1">
            ...
            <div class="flex flex-wrap items-center justify-between -m-2">
                ...
                <div class="relative m-2 mr-4">
                    ...
                    <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 m-auto" :class="slugTopic ? 'text-blue-500' : 'text-gray-400'" viewBox="0 0 20 20" fill="currentColor">
